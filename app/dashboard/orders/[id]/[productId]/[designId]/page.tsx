...
export default function ViewDesignItemPage() {
    ...
    const { isLoading, isSubmitting, fetchDesignItemDetails, designItem, fetchDesignFilesMetaData, designFileStatus, qaStatus } = useDesignFiles();
    ...
    return(
        <div>
            <div className="mb-6 flex justify-between">
                ...
                <div>
                    <CreateButton label='Create Design File' icon={<PlusIcon />} />
                </div>
            </div>
            ...
            <div className='bg-red-600 w-full p-3'>
