...
interface DesignItemDetailsProps {
    designItem: DesignItem;
}

export default function DesignItemDetails({ designItem }: DesignItemDetailsProps) {
    const getStatusColor = (status: string) => {
        switch (status?.toLowerCase()) {
            ...
            case "pending":
                return "bg-light-700 text-primary-800";
            default:
                return "bg-light-500 text-primary-800";
        }
    };
    ...
    const getQAStatusColor = (qaStatus: string) => {
        switch (qaStatus?.toLowerCase()) {
            ...
            case "pending":
                return "text-light-900 bg-light-300";
            default:
                return "text-light-900 bg-light-300";
        }
    };
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <p className="text-xl font-bold text-primary-800">
                                    {designItem.design_order.order_name}
                                </p>
                            </div>
                            <div className="space-y-2">
                                <p className="text-sm text-primary-600 font-medium uppercase tracking-wide">
                                ...
                                <p className="text-xl font-mono font-bold text-accent-600">
                                    {designItem.design_order.order_number}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-8 space-y-6">
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <p className="text-xl font-bold text-primary-800">
                                    {designItem.design_product.product_name}
                                </p>
                            </div>
                            <div className="space-y-2">
                                <p className="text-sm text-primary-600 font-medium uppercase tracking-wide">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <span
                                    className={`inline-flex items-center capitalize gap-2 px-4 py-2 rounded-lg text-sm font-semibold ${getStatusColor(
                            ...
                            <div className="space-y-2">
                                ...
                                <span
                                    className={`inline-flex items-center capitalize gap-2 px-4 py-2 rounded-lg text-sm font-semibold ${getQAStatusColor(
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-light-300">
                    ...
                    <div className="p-6 space-y-6">
                        <div className="space-y-2">
                            ...
                            <span
                                className={`inline-flex items-center capitalize gap-2 px-4 py-2 rounded-lg text-sm font-semibold w-full justify-center ${getStatusColor(
                                designItem.status
                                )}`}
                            >
                                {designItem.status}
                        ...
                        <div className="space-y-2">
                            ...
                            <span
                                className={`inline-flex items-center capitalize gap-2 px-4 py-2 rounded-lg text-sm font-semibold w-full justify-center ${getQAStatusColor(
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-light-100 rounded-lg">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-primary-800 font-mono font-semibold">
                                {designItem.id}
                            </p>
                        </div>
                    </div>
                    {designItem.file_name && (
                        <div className="flex items-start gap-3 p-4 bg-light-100 rounded-lg">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-primary-800 font-semibold truncate">
                                    {designItem.file_name}
                                </p>
                            </div>
                        </div>
