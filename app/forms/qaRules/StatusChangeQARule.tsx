...
function StatusChangeQARule({ row, onConfirm, onCancel, isSubmitting }: ModalProps) {
                ...
                <div className="relative p-6 overflow-hidden bg-gradient-to-r from-primary-800 to-primary-700 rounded-t-2xl">
                    ...
                    <div className="relative flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-white">{status === 'active' ? 'Deactivate' : 'Activate'} QA Rule</h2>
                                <p className="text-sm text-error-100">Please confirm the QA Rule {status === 'active' ? 'deactivation' : 'activation'}</p>
                            </div>
                        </div>
                        <button
                            onClick={onCancel}
...
export default StatusChangeQARule;