...
import { ClipboardCheck, FileText, Shield, ShoppingCart, Tag, User, X } from "lucide-react";
                ...
                <div className="relative p-6 overflow-hidden bg-gradient-to-r from-primary-700 to-primary-600 rounded-t-2xl">
                    ...
                    <div className="relative flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-white">QA Rule Details</h2>
                                <p className="text-sm text-primary-100">View complete QA rule information</p>
                            </div>
                        </div>
                        <button
                            onClick={handleClose}
                        ...
                        <div className="flex items-start justify-between gap-4">
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <label className="text-sm font-semibold text-primary-700">Rule Name</label>
                                </div>
                                <h3 className="text-xl font-bold text-primary-900">{row.rule_name}</h3>
                            </div>
