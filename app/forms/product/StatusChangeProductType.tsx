...
function StatusChangeProductType({ row, onConfirm, onCancel, isSubmitting }: ModalProps) {
                ...
                <div className="relative bg-gradient-to-r from-primary-800 to-primary-700 rounded-t-2xl p-6 overflow-hidden">
                    ...
                    <div className="relative flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-white">{status === 'active' ? 'Deactivate' : 'Activate'} Product Type</h2>
                                <p className="text-error-100 text-sm">Please confirm the product type {status === 'active' ? 'deactivation' : 'activation'}</p>
                            </div>
                        </div>
                        <button
                            onClick={onCancel}
...
export default StatusChangeProductType;